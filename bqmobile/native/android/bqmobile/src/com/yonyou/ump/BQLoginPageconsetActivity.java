...
public abstract class BQLoginPageconsetActivity extends UMWindowActivity {

	protected UMWindow BQLoginPageconset = null;
...
protected UMButton button0 = null;
	...
	protected final static int ID_BQLOGINPAGECONSET = 1855197049;
protected final static int ID_VIEWPAGE0 = 1004825261;
protected final static int ID_NAVIGATORBAR0 = 1181679878;
protected final static int ID_LABEL0 = 1562947572;
protected final static int ID_LABEL2 = 2145109588;
protected final static int ID_LABEL1 = 610138325;
protected final static int ID_PANEL0 = 366901124;
protected final static int ID_TEXTBOX0 = 1866748174;
protected final static int ID_LABEL3 = 660539908;
protected final static int ID_TEXTBOX1 = 1086999416;
protected final static int ID_PANEL1 = 803965282;
protected final static int ID_LABEL4 = 1408095052;
protected final static int ID_LABEL5 = 1911990073;
protected final static int ID_SWITCH0 = 1636537138;
protected final static int ID_BUTTON0 = 254740058;
	...
	public String getControllerName() {
		return "BQLoginPageconsetController";
	}
...
this.setContentView(currentPage);
	...
	private void registerControl() {
		  idmap.put("BQLoginPageconset",ID_BQLOGINPAGECONSET);
...
button0.setOnClickListener(new View.OnClickListener() {
  ...
  public void onClick(View v) {
    UMEventArgs args = new UMEventArgs(BQLoginPageconsetActivity.this);
...
BQLoginPageconset = (UMWindow)ThirdControl.createControl(new UMWindow(context),ID_BQLOGINPAGECONSET
,"halign","center"
,"height","fill"
,"layout-type","linear"
,"layout","vbox"
...
,"controller","BQLoginPageconsetController"
,"namespace","com.yonyou"
);
BQLoginPageconset.setup();
View viewPage0 = (View) getViewPage0View((UMActivity)context,binderGroup,configure);
BQLoginPageconset.addView(viewPage0);

return (UMWindow)BQLoginPageconset;
}
...
public void actionCloseWindow(View control, UMEventArgs args) {
    ...
    args.put("viewid","com.yonyou.BQLoginPage");
    args.put("ishttps","#{ishttps}");
